...
, subscription_status TEXT DEFAULT 'active', subscription_expires_at INTEGER);
...
CREATE INDEX idx_infractions_issuer ON infractions(issuer_id);

CREATE INDEX idx_infractions_resolved ON infractions(resolved);
